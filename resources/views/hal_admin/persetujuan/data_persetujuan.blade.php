...
@section('konten') 
        ...
        <main>
            <div class="container-fluid px-4">
                <h2 class="mt-4"> Data Persetujuan PKL </h2>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Dashboard Admin/ Persetujuan Data PKL</li>
                </ol>
                <div class="row"> 
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header bg-info text-white text-center">
                                 <h5> Data Persetujuan PKL </h5> 
                            </div> 
                            <div class="card-body">
                                <p> Berikut Seluruh Persetujuan PKL :  </p>
